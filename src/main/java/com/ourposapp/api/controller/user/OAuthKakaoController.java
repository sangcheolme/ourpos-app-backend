...
import com.ourposapp.infra.oauth.kakao.client.KakaoTokenClient;
import com.ourposapp.infra.oauth.kakao.dto.KakaoTokenDto;
...
public class OAuthKakaoController {
    ...
    public void kakaoLoginCallback(String code, HttpServletResponse response) throws IOException {
        ...
        KakaoTokenDto.Response tokenResponse = kakaoTokenClient.requestKakaoToken(CONTENT_TYPE, kakaoTokenRequest);
