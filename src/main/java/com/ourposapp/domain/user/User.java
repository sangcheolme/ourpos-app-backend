...
import com.ourposapp.support.util.DateTimeUtils;
...
public class User extends BaseTimeEntity {
    ...
    public void updateUserAddress(UserAddressUpdateRequest userAddressUpdateRequest) {
        UserAddress userAddress = getUserAddress(userAddressUpdateRequest.getUserAddressId());
        userAddress.update(
                userAddressUpdateRequest.getAddressName(),
                userAddress.getReceiverName(),
                userAddressUpdateRequest.getPhoneNumber(),
                userAddressUpdateRequest.getAddress1(),
                userAddressUpdateRequest.getAddress2(),
                userAddressUpdateRequest.getZipcode()
        );
    }
    ...
    public void changeDefaultUserAddress(Long newDefaultAddressId) {
        ...
        if (Boolean.TRUE.equals(newDefaultAddress.getDefaultYn())) {
    ...
    public void deleteUserAddress(Long userAddressId) {
        ...
        if (Boolean.TRUE.equals(userAddress.getDefaultYn())) {
